from automata_toolkit.regex_to_postfix import regex_to_postfix, is_alphabet
...
def get_alphabet_nfa(character, alphabets):
    nfa = {}
    nfa["states"] = [str(uuid.uuid4()), str(uuid.uuid4())]
...
def union_nfa(nfa1, nfa2):
    ...
    nfa["transition_function"][nfa["initial_state"]][Consts.EPSILON].extend(
        [nfa1["initial_state"], nfa2["initial_state"]])
    return nfa
...
def cleene_star_nfa(nfa1):
    ...
    nfa["states"] = [str(uuid.uuid4())]
    nfa["states"].extend(nfa1["states"])
    nfa["states"].append(str(uuid.uuid4()))
    ...
    nfa["transition_function"][nfa["initial_state"]
                               ][Consts.EPSILON].append(nfa1["initial_state"])
